...
int main() {
    ...
    //unlink("/home/nikolai/life_file/field");
   // unlink("/home/nikolai/life_file/fieldNext");
    int fInd1 =  open("/home/nikolai/life_file/field",O_RDWR | O_CREAT, S_IRWXG | S_IRWXU);
    struct stat buffer;
    printf("%d \n",stat(fInd1, &buffer));
  //  int u = ftruncate(fInd1, size);

    int fInd2 =  open("/home/nikolai/life_file/fieldNext",O_RDWR | O_CREAT, S_IRWXG | S_IRWXU);
...
*/
    ...
    */
    ...
    int number;
    for (int i = 0; i < n; ++i) {
        pthread_create(&pthreads[i], 0, &live, (void*)i);
    }
    mainFunction();
